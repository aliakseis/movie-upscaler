...
/* in this example, we choose transcoding to same codec */
    ...
    enc_ctx->height = videoCodecContext->height * upscale;
    enc_ctx->width = videoCodecContext->width * upscale;
    ...
    videoFrameOut->width = videoCodecContext->width * upscale;
    videoFrameOut->height = videoCodecContext->height * upscale;
        ...
        if (packet.stream_index == videoStreamNumber)
        {
            ...
            while (avcodec_receive_frame(videoCodecContext, videoFrame.get()) == 0)
            {
                ...
                sws_scale(reverse_convert_ctx,
                    ...
                    &stride,
                    //&videoFrame->width,
                    0, videoCodecContext->height * upscale, //pFrameRGB->data, pFrameRGB->linesize);
                    //(uint8_t*)
